    ...
    <div class="data">
      ...
      <div class="grid" style="margin-top: 5px">
        ...
        >
          ...
          <el-table-column prop="createTime" label="创立时间" width="110" />
          <el-table-column
            prop="about"
            label="信息"
            width="470"
    ...
    >
      ...
      <el-form :model="sfm" ref="sfRef">
        <el-row :gutter="20">
          ...
          <el-col :span="11">
            <el-form-item label="科室名称:" label-width="45" prop="name">
              <el-input
                v-model="sfm.name"
                placeholder="请输入科室名称"
              /> </el-form-item
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12" :offset="1"
            ><el-form-item label="创立日期:" label-width="75" prop="createTime">
              <el-date-picker
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12" :offset="1"
            ><el-form-item label="地址:" label-width="75" prop="address">
              <el-input
                v-model="sfm.address"
                placeholder="请输入科室地址"
              /> </el-form-item
